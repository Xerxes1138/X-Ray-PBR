...
CROS_impl::CROS_impl	()
{
	...
	result_frame		= u32(-1);
	result_sun			= 0;
	hemi_value			= 1.0f; // 0.5f
	hemi_smooth			= 1.0f; // 0.5f
	sun_value			= 1.0f; // 0.2f
	sun_smooth			= 1.0f; // 0.2f
...
//	float	l_i				=	1.f-l_f;
	...
	// DEBUG
	//Fvector			accum	=	{ 1.0f /*desc.ambient.x*/,		1.0f /*desc.ambient.y*/,		1.0f /*desc.ambient.z*/		};
	//Fvector			hemi	=	{ 1.0f /*desc.hemi_color.x*/,	1.0f /*desc.hemi_color.y*/,	1.0f /*desc.hemi_color.z*/	};
	//Fvector			sun_	=	{ 1.0f /*desc.sun_color.x*/,	1.0f	/*desc.sun_color.y*/,	1.0f /*desc.sun_color.z*/	};
	
	// DEBUG
	//approximate.set(1.0f,		1.0f,		1.0f);
