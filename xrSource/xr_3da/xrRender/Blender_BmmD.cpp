...
void	CBlender_BmmD::Compile	(CBlender_Compile& C)
{
	...
	if (C.bEditor)	{
		...
		case SE_R1_NORMAL_HQ:	
			...
			C.r_Sampler		("s_detail",oT2_Name,false,	D3DTADDRESS_CLAMP,	D3DTEXF_LINEAR,		D3DTEXF_LINEAR,	D3DTEXF_LINEAR, true);
			C.r_End			();
			break;
...
void	CBlender_BmmD::Compile	(CBlender_Compile& C)
{
	...
	case SE_R2_NORMAL_HQ: 		// deffer
		...
		C.r_Sampler		("s_mask",	mask, 	false,	D3DTADDRESS_CLAMP,	D3DTEXF_LINEAR,		D3DTEXF_LINEAR,	D3DTEXF_LINEAR, true);
		C.r_Sampler		("s_lmap",	C.L_textures[1]);
