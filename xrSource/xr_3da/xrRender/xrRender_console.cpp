...
float		ps_r2_tonemap_bias			= 1.5f;				// r2-only
...
float		ps_r2_rain_puddle_scale		= 20.0f;

float		ps_r2_dhemi_scale			= 1.0f;				// 1.5f
...
// SSAO
float		ps_r2_ssao_size				= 0.01f;
float		ps_r2_ssao_length			= 0.05f;
float		ps_r2_ssao_thickness		= 0.008f;
int			ps_r2_ssao_samples			= 12;
//

// SSR
Flags32		ps_r2_ssr_flags				= {R2FLAG_SSR_RAYCAST_HALF};
float		ps_r2_ssr_atten_border		= 0.0625f;
...
//.	CMD4(CCC_Float,		"r__detail_density",	&ps_r__Detail_density,		.05f,	0.99f	);
	...
	CMD4(CCC_Float,		"r2_tonemap_bias",		&ps_r2_tonemap_bias,		0.0f,	10.0f	);
	...
	//RAIN
	CMD4(CCC_Float,		"r2_rain_puddle_scale", &ps_r2_rain_puddle_scale,	1.0f,	100.0f	);
	//
...
//	CMD4(CCC_Float,		"r2_parallax_range",	&ps_r2_df_parallax_range,	5.0f,	175.0f	);
	...
	// SSAO
	CMD4(CCC_Float,	"r2_ssao_size", &ps_r2_ssao_size, 1e-5f, 1.0f);
	CMD4(CCC_Float,	"r2_ssao_length", &ps_r2_ssao_length, 1e-5f, 1.0f);
	CMD4(CCC_Float,	"r2_ssao_thickness", &ps_r2_ssao_thickness, 1e-5f, 1.0f);
	CMD4(CCC_Integer, "r2_ssao_samples", &ps_r2_ssao_samples, 4, 32);
	//


	// SSR
	CMD3(CCC_Mask, "r2_ssr_raycast_half", &ps_r2_ssr_flags, R2FLAG_SSR_RAYCAST_HALF);
	CMD4(CCC_Float,	"r2_ssr_atten_border", &ps_r2_ssr_atten_border, 1e-5f, 1.0f);
